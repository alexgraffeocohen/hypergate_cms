...
ComfortableMexicanSofa.configure do |config|
  ...
  config.cms_title = 'Hypergate Wiki'
...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = Rails.application.secrets.wiki_username
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = Rails.application.secrets.wiki_password
